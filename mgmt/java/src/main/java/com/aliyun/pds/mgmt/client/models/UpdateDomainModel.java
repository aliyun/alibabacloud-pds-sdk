...
public class UpdateDomainModel extends TeaModel {
    ...
    public UpdateDomainModel setHeaders(java.util.Map<String, String> headers) {
    ...
    public UpdateDomainModel setBody(UpdateDomainResponse body) {
        this.body = body;
        return this;
    }
    public UpdateDomainResponse getBody() {
        return this.body;
    }

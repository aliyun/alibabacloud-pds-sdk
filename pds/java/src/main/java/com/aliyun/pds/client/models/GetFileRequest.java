...
public class GetFileRequest extends TeaModel {
    ...
    public GetFileRequest setHeaders(java.util.Map<String, String> headers) {
    ...
    public GetFileRequest setFilterFileAsShareLink(Boolean filterFileAsShareLink) {
    ...
    public GetFileRequest setFilterFileFieldAsShareLink(Boolean filterFileFieldAsShareLink) {

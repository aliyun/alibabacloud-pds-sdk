...
public class CCPWalkFileRequest extends TeaModel {
    ...
    public CCPWalkFileRequest setFilterFileAsShareLink(Boolean filterFileAsShareLink) {
    ...
    public CCPWalkFileRequest setFilterFileFieldAsShareLink(Boolean filterFileFieldAsShareLink) {

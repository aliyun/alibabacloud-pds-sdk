...
public class UpdateShareLinkResponse extends TeaModel {
    ...
    public UpdateShareLinkResponse setCreatable(Boolean creatable) {
    ...
    public UpdateShareLinkResponse setCreatableFileIdList(java.util.List<String> creatableFileIdList) {
    ...
    public UpdateShareLinkResponse setDisableVisible(Boolean disableVisible) {

 ...
 * Base file response
 */
export class BaseFileResponse extends $tea.Model {
  category?: string;
  contentHash?: string;
...
export class ListFileResponse extends $tea.Model {
  ...
  static types(): { [key: string]: any } {
    return {
      items: { 'type': 'array', 'itemType': BaseFileResponse },
      nextMarker: 'string',
    };
  }
 ...
 */
export class OSSVideoDRMLicenseResponse extends $tea.Model {
  data: string;
  states: number;
  static names(): { [key: string]: string } {
    return {
 ...
 * 获取视频DRM License
 */
export class OSSVideoDRMLicenseRequest extends $tea.Model {
  drmType: string;
...
export class GetStoryTaskModel extends $tea.Model {
  headers?: { [key: string]: string };
  body: GetStoryTaskResponse;
  static names(): { [key: string]: string } {
    return {
      headers: 'headers',
      body: 'body',
 ...
 */
export class GetStoryTaskRequest extends $tea.Model {
  headers?: { [key: string]: string };
  driveId: string;
  static names(): { [key: string]: string } {
    return {
 ...
 * 故事任务状态
 */
export class GetStoryTaskResponse extends $tea.Model {
  driveId?: string;
  status?: string;
  static names(): { [key: string]: string } {
    return {
...
export default class Client {
   ...
   * @error InternalError The request has been failed due to some unknown error.
   */
  async getPublicKeyEx(request: GetAppPublicKeyRequest, runtime: RuntimeOptions): Promise<GetPublicKeyModel> {
    let _runtime: { [key: string]: any } = {
      timeouted: "retry",
      readTimeout: runtime.readTimeout,
      connectTimeout: runtime.connectTimeout,
   ...
   * @error ServiceUnavailable The request has failed due to a temporary failure of the server.
   */
  async getStoryTaskEx(request: GetStoryTaskRequest, runtime: RuntimeOptions): Promise<GetStoryTaskModel> {
    let _runtime: { [key: string]: any } = {
      timeouted: "retry",
      readTimeout: runtime.readTimeout,
      connectTimeout: runtime.connectTimeout,
    ...
    while ($tea.allowRetry(_runtime['retry'], _retryTimes, _now)) {
      ...
      try {
        ...
        request_.protocol = Util.defaultString(this._protocol, "https");
        request_.method = "POST";
        request_.pathname = this.getPathname(this._nickname, `/v2/image/get_story_task`);
        request_.headers = {
          'user-agent': this.getUserAgent(),
          host: Util.defaultString(this._endpoint, `${this._domainId}.api.aliyunpds.com`),
          'content-type': "application/json; charset=utf-8",
        ...
        if (Util.equalNumber(response_.statusCode, 200)) {
          obj = await Util.readAsJSON(response_.body);
          respMap = Util.assertAsMap(obj);
          return $tea.cast<GetStoryTaskModel>({
            body: respMap,
            headers: response_.headers,
   ...
   * @error InternalError The request has been failed due to some unknown error.
   */
  async getPublicKey(request: GetAppPublicKeyRequest): Promise<GetPublicKeyModel> {
    let runtime = new RuntimeOptions({ });
   ...
   * @error ServiceUnavailable The request has failed due to a temporary failure of the server.
   */
  async getStoryTask(request: GetStoryTaskRequest): Promise<GetStoryTaskModel> {
    let runtime = new RuntimeOptions({ });
    return await this.getStoryTaskEx(request, runtime);
  }

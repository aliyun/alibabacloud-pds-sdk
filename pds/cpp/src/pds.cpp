...
AccountTokenModel
Alibabacloud_Pds::Client::accountTokenEx(shared_ptr<TokenRequest> request,
                                         shared_ptr<RuntimeOptions> runtime) {
  request->validate();
  runtime->validate();
  shared_ptr<map<string, boost::any>> runtime_ = make_shared<
...
GetStoryTaskModel Alibabacloud_Pds::Client::getStoryTaskEx(
    shared_ptr<GetStoryTaskRequest> request,
    shared_ptr<RuntimeOptions> runtime) {
  request->validate();
  runtime->validate();
  shared_ptr<map<string, boost::any>> runtime_ = make_shared<
  ...
  while (Darabonba::Core::allowRetry(
    ...
    try {
      ...
      request_->method = "POST";
      request_->pathname = getPathname(
          _nickname, make_shared<string>(string("/v2/image/get_story_task")));
      request_->headers = Darabonba::Converter::merge(
          map<string, string>(
              {{"user-agent", getUserAgent()},
               {"host", Darabonba_Util::Client::defaultString(
...
ListFaceGroupsModel Alibabacloud_Pds::Client::listFaceGroupsEx(
  ...
  while (Darabonba::Core::allowRetry(
    ...
    try {
      ...
      request_->method = "POST";
      request_->pathname = getPathname(
          _nickname, make_shared<string>(string("/v2/image/list_face_groups")));
      request_->headers = Darabonba::Converter::merge(
          map<string, string>(
              {{"user-agent", getUserAgent()},
               {"host", Darabonba_Util::Client::defaultString(
...
AccountTokenModel
Alibabacloud_Pds::Client::accountToken(shared_ptr<TokenRequest> request) {
  shared_ptr<RuntimeOptions> runtime = make_shared<RuntimeOptions>();
...
GetStoryTaskModel Alibabacloud_Pds::Client::getStoryTask(
    shared_ptr<GetStoryTaskRequest> request) {
  shared_ptr<RuntimeOptions> runtime = make_shared<RuntimeOptions>();
  return getStoryTaskEx(request, runtime);
}

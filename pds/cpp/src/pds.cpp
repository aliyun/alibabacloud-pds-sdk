  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      request_->headers = Darabonba::Converter::merge(map<string, string>({
        ...
        {"host", Darabonba_Util::Client::defaultString(_endpoint, make_shared<string>(string("" + *_domainId + ".auth.aliyunpds.com")))},
      ...
      if (!Darabonba_Util::Client::empty(accessToken)) {
        request_->headers.insert(pair<string, string>("authorization", string("Bearer " + *accessToken + "")));
      }
...
GetPublicKeyModel Alibabacloud_Pds::Client::getPublicKeyEx(shared_ptr<GetAppPublicKeyRequest> request, shared_ptr<RuntimeOptions> runtime) {
  request->validate();
  runtime->validate();
  shared_ptr<map<string, boost::any>> runtime_ = make_shared<map<string, boost::any>>(map<string, boost::any>({
    {"timeouted", boost::any(string("retry"))},
...
AdminListStoresModel Alibabacloud_Pds::Client::adminListStoresEx(shared_ptr<AdminListStoresRequest> request, shared_ptr<RuntimeOptions> runtime) {
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      request_->headers = Darabonba::Converter::merge(map<string, string>({
        {"user-agent", getUserAgent()},
        {"host", Darabonba_Util::Client::defaultString(_endpoint, make_shared<string>(string("" + *_domainId + ".api.aliyunpds.com")))},
        {"content-type", "application/json; charset=utf-8"}
      }), !request->headers ? map<string, string>() : *request->headers);
      (*realReq)["headers"] = nullptr;
      if (!Darabonba_Util::Client::empty(accessToken)) {
...
GetStoryTaskModel Alibabacloud_Pds::Client::getStoryTaskEx(shared_ptr<GetStoryTaskRequest> request, shared_ptr<RuntimeOptions> runtime) {
  request->validate();
  runtime->validate();
  shared_ptr<map<string, boost::any>> runtime_ = make_shared<map<string, boost::any>>(map<string, boost::any>({
    {"timeouted", boost::any(string("retry"))},
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      request_->protocol = Darabonba_Util::Client::defaultString(_protocol, make_shared<string>("https"));
      request_->method = "POST";
      request_->pathname = getPathname(_nickname, make_shared<string>(string("/v2/image/get_story_task")));
      request_->headers = Darabonba::Converter::merge(map<string, string>({
        {"user-agent", getUserAgent()},
        {"host", Darabonba_Util::Client::defaultString(_endpoint, make_shared<string>(string("" + *_domainId + ".api.aliyunpds.com")))},
        {"content-type", "application/json; charset=utf-8"}
...
GetPublicKeyModel Alibabacloud_Pds::Client::getPublicKey(shared_ptr<GetAppPublicKeyRequest> request) {
  shared_ptr<RuntimeOptions> runtime = make_shared<RuntimeOptions>();
...
GetStoryTaskModel Alibabacloud_Pds::Client::getStoryTask(shared_ptr<GetStoryTaskRequest> request) {
  shared_ptr<RuntimeOptions> runtime = make_shared<RuntimeOptions>();
...
void Alibabacloud_Pds::Client::appendUserAgent(shared_ptr<string> userAgent) {
  _userAgent = make_shared<string>(string("" + *_userAgent + " " + *userAgent + ""));
}

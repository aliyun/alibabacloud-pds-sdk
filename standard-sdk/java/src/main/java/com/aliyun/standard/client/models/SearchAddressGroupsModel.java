...
public class SearchAddressGroupsModel extends TeaModel {
    ...
    public SearchAddressGroupsModel setHeaders(java.util.Map<String, String> headers) {
    ...
    public SearchAddressGroupsModel setBody(SearchImageAddressGroupsResponse body) {
        this.body = body;
        return this;
    }
    public SearchImageAddressGroupsResponse getBody() {
        return this.body;
    }

...
public class OSSVideoM3U8Request extends TeaModel {
    ...
    public OSSVideoM3U8Request setDefinition(String definition) {
    ...
    public OSSVideoM3U8Request setDriveId(String driveId) {
    ...
    public OSSVideoM3U8Request setExpireSec(Long expireSec) {
    ...
    public OSSVideoM3U8Request setFilePath(String filePath) {
    ...
    public OSSVideoM3U8Request setProtectionScheme(String protectionScheme) {
    ...
    public OSSVideoM3U8Request setShareId(String shareId) {
    ...
    public OSSVideoM3U8Request setSignToken(String signToken) {

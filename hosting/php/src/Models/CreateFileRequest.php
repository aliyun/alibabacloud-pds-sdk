...
use Aliyun\Hosting\SDK\Models\ImageMediaMetadata;
use Aliyun\Hosting\SDK\Models\UploadPartInfo;
use Aliyun\Hosting\SDK\Models\VideoMediaMetadata;
...
class CreateFileRequest extends Model {
    ...
    public function toMap() {
        ...
        if (null !== $this->forceUploadToLocation) {
            $res['force_upload_to_location'] = $this->forceUploadToLocation;
        }
        if (null !== $this->hidden) {
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['force_upload_to_location'])){
            $model->forceUploadToLocation = $map['force_upload_to_location'];
        }
        if(isset($map['hidden'])){
    ...
    /**
     * @description force_upload_to_location
     * @var bool
     */
    public $forceUploadToLocation;

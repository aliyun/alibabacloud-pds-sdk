...
use Aliyun\Hosting\SDK\Models\ImageMediaResponse;
use Aliyun\Hosting\SDK\Models\VideoMediaResponse;
use Aliyun\Hosting\SDK\Models\VideoPreviewResponse;
...
class CompleteFileResponse extends Model {
    ...
    public function toMap() {
        ...
        if (null !== $this->streamLocations) {
            $res['stream_locations'] = $this->streamLocations;
        }
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['stream_locations'])){
            $model->streamLocations = $map['stream_locations'];
        }

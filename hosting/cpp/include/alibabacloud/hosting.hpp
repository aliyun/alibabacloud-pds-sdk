...
#ifndef ALIBABACLOUD_HOSTING_H_
#define ALIBABACLOUD_HOSTING_H_
...
public:
  ...
  HostingCompleteFileResponse() {}

  explicit HostingCompleteFileResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingCompleteFileResponse> body{};
...
public:
  ...
  HostingCopyFileResponse() {}

  explicit HostingCopyFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingCopyFileResponse> body{};
...
public:
  ...
  HostingCreateFileResponse() {}

  explicit HostingCreateFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingCreateFileResponse> body{};
...
public:
  ...
  HostingGetFileResponse() {}

  explicit HostingGetFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingGetFileResponse> body{};
...
public:
  ...
  HostingGetDownloadUrlResponse() {}

  explicit HostingGetDownloadUrlResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingGetDownloadUrlResponse> body{};
...
public:
  ...
  HostingGetSecureUrlResponse() {}

  explicit HostingGetSecureUrlResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingGetSecureUrlResponse> body{};

  GetSecureUrlModel() {}

  explicit GetSecureUrlModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingGetUploadUrlResponse() {}

  explicit HostingGetUploadUrlResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingGetUploadUrlResponse> body{};
...
public:
  ...
  BaseHostingFileResponse() {}

  explicit BaseHostingFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<vector<BaseHostingFileResponse>> items{};
  shared_ptr<string> nextMarker{};

  HostingListFileResponse() {}

  explicit HostingListFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    if (m.find("items") != m.end() && !m["items"].empty()) {
      if (typeid(vector<boost::any>) == m["items"].type()) {
        ...
        items = make_shared<vector<BaseHostingFileResponse>>(expect1);
      }
    }
    if (m.find("next_marker") != m.end() && !m["next_marker"].empty()) {
      nextMarker =
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingListFileResponse> body{};
...
public:
  ...
  HostingListUploadedPartResponse() {}

  explicit HostingListUploadedPartResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingListUploadedPartResponse> body{};
...
public:
  ...
  HostingMoveFileResponse() {}

  explicit HostingMoveFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingMoveFileResponse> body{};
...
public:
  ...
  HostingVideoDefinitionResponse() {}

  explicit HostingVideoDefinitionResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingVideoDefinitionResponse> body{};

  VideoDefinitionModel() {}

  explicit VideoDefinitionModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingVideoDRMLicenseResponse() {}

  explicit HostingVideoDRMLicenseResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  map<string, boost::any> toMap() override {
    ...
    if (deviceInfo) {
      res["device_info"] = boost::any(*deviceInfo);
    }
    return res;
  }
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("device_info") != m.end() && !m["device_info"].empty()) {
      deviceInfo =
          make_shared<string>(boost::any_cast<string>(m["device_info"]));
    }
  }
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingVideoDRMLicenseResponse> body{};

  VideoLicenseModel() {}

  explicit VideoLicenseModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit VideoM3u8Model(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
  ...
  void fromMap(map<string, boost::any> m) override {
    ...
    if (m.find("body") != m.end() && !m["body"].empty()) {
      body = make_shared<vector<uint8_t>>(
          boost::any_cast<vector<uint8_t>>(m["body"]));
    }
  }
...
public:
  ...
  HostingVideoTranscodeResponse() {}

  explicit HostingVideoTranscodeResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<HostingVideoTranscodeResponse> body{};

  VideoTranscodeModel() {}

  explicit VideoTranscodeModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<CreateShareResponse> body{};

  CreateShareModel() {}

  explicit CreateShareModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit DeleteShareModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<GetShareResponse> body{};

  GetShareModel() {}

  explicit GetShareModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<ListShareResponse> body{};

  ListShareModel() {}

  explicit ListShareModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<UpdateShareResponse> body{};

  UpdateShareModel() {}

  explicit UpdateShareModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  shared_ptr<map<string, string>> headers{};
  shared_ptr<ListStoreFileResponse> body{};

  ListStorefileModel() {}

  explicit ListStorefileModel(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingCompleteFileRequest() {}

  explicit HostingCompleteFileRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingCopyFileRequest() {}

  explicit HostingCopyFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingCreateFileRequest() {}

  explicit HostingCreateFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit HostingDeleteFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  explicit HostingDeleteFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingDeleteFilesResponse() {}

  explicit HostingDeleteFilesResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingGetDownloadUrlRequest() {}

  explicit HostingGetDownloadUrlRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingGetFileRequest() {}

  explicit HostingGetFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingGetSecureUrlRequest() {}

  explicit HostingGetSecureUrlRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingGetUploadUrlRequest() {}

  explicit HostingGetUploadUrlRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingListFileRequest() {}

  explicit HostingListFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingListUploadedPartRequest() {}

  explicit HostingListUploadedPartRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingMoveFileRequest() {}

  explicit HostingMoveFileRequest(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingSearchFileResponse() {}

  explicit HostingSearchFileResponse(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingUpdateFileMetaResponse() {}

  explicit HostingUpdateFileMetaResponse(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingVideoDRMLicenseRequest() {}

  explicit HostingVideoDRMLicenseRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingVideoDefinitionRequest() {}

  explicit HostingVideoDefinitionRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingVideoM3U8Request() {}

  explicit HostingVideoM3U8Request(const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  HostingVideoTranscodeRequest() {}

  explicit HostingVideoTranscodeRequest(
      const std::map<string, boost::any> &config)
      : Darabonba::Model(config) {
    fromMap(config);
  };
...
public:
  ...
  UpdateDriveModel updateDriveEx(shared_ptr<UpdateDriveRequest> request,
                                 shared_ptr<RuntimeOptions> runtime);
  CompleteFileModel
  completeFileEx(shared_ptr<HostingCompleteFileRequest> request,
                 shared_ptr<RuntimeOptions> runtime);
  CopyFileModel copyFileEx(shared_ptr<HostingCopyFileRequest> request,
                           shared_ptr<RuntimeOptions> runtime);
  CreateFileModel createFileEx(shared_ptr<HostingCreateFileRequest> request,
                               shared_ptr<RuntimeOptions> runtime);
  DeleteFileModel deleteFileEx(shared_ptr<HostingDeleteFileRequest> request,
                               shared_ptr<RuntimeOptions> runtime);
  GetFileModel getFileEx(shared_ptr<HostingGetFileRequest> request,
                         shared_ptr<RuntimeOptions> runtime);
  GetDownloadUrlModel
  getDownloadUrlEx(shared_ptr<HostingGetDownloadUrlRequest> request,
                   shared_ptr<RuntimeOptions> runtime);
  GetSecureUrlModel
  getSecureUrlEx(shared_ptr<HostingGetSecureUrlRequest> request,
                 shared_ptr<RuntimeOptions> runtime);
  GetUploadUrlModel
  getUploadUrlEx(shared_ptr<HostingGetUploadUrlRequest> request,
                 shared_ptr<RuntimeOptions> runtime);
  ListFileModel listFileEx(shared_ptr<HostingListFileRequest> request,
                           shared_ptr<RuntimeOptions> runtime);
  ListUploadedPartsModel
  listUploadedPartsEx(shared_ptr<HostingListUploadedPartRequest> request,
                      shared_ptr<RuntimeOptions> runtime);
  MoveFileModel moveFileEx(shared_ptr<HostingMoveFileRequest> request,
                           shared_ptr<RuntimeOptions> runtime);
  VideoDefinitionModel
  videoDefinitionEx(shared_ptr<HostingVideoDefinitionRequest> request,
                    shared_ptr<RuntimeOptions> runtime);
  VideoLicenseModel
  videoLicenseEx(shared_ptr<HostingVideoDRMLicenseRequest> request,
                 shared_ptr<RuntimeOptions> runtime);
  VideoM3u8Model videoM3u8Ex(shared_ptr<HostingVideoM3U8Request> request,
                             shared_ptr<RuntimeOptions> runtime);
  VideoTranscodeModel
  videoTranscodeEx(shared_ptr<HostingVideoTranscodeRequest> request,
                   shared_ptr<RuntimeOptions> runtime);
  CreateShareModel createShareEx(shared_ptr<CreateShareRequest> request,
                                 shared_ptr<RuntimeOptions> runtime);
  DeleteShareModel deleteShareEx(shared_ptr<DeleteShareRequest> request,
                                 shared_ptr<RuntimeOptions> runtime);
  GetShareModel getShareEx(shared_ptr<GetShareRequest> request,
                           shared_ptr<RuntimeOptions> runtime);
  ListShareModel listShareEx(shared_ptr<ListShareRequest> request,
                             shared_ptr<RuntimeOptions> runtime);
  UpdateShareModel updateShareEx(shared_ptr<UpdateShareRequest> request,
                                 shared_ptr<RuntimeOptions> runtime);
  ListStorefileModel listStorefileEx(shared_ptr<ListStoreFileRequest> request,
                                     shared_ptr<RuntimeOptions> runtime);
  ...
  CompleteFileModel
  completeFile(shared_ptr<HostingCompleteFileRequest> request);
  CopyFileModel copyFile(shared_ptr<HostingCopyFileRequest> request);
  CreateFileModel createFile(shared_ptr<HostingCreateFileRequest> request);
  DeleteFileModel deleteFile(shared_ptr<HostingDeleteFileRequest> request);
  GetFileModel getFile(shared_ptr<HostingGetFileRequest> request);
  GetDownloadUrlModel
  getDownloadUrl(shared_ptr<HostingGetDownloadUrlRequest> request);
  GetSecureUrlModel
  getSecureUrl(shared_ptr<HostingGetSecureUrlRequest> request);
  GetUploadUrlModel
  getUploadUrl(shared_ptr<HostingGetUploadUrlRequest> request);
  ListFileModel listFile(shared_ptr<HostingListFileRequest> request);
  ListUploadedPartsModel
  listUploadedParts(shared_ptr<HostingListUploadedPartRequest> request);
  MoveFileModel moveFile(shared_ptr<HostingMoveFileRequest> request);
  VideoDefinitionModel
  videoDefinition(shared_ptr<HostingVideoDefinitionRequest> request);
  VideoLicenseModel
  videoLicense(shared_ptr<HostingVideoDRMLicenseRequest> request);
  VideoM3u8Model videoM3u8(shared_ptr<HostingVideoM3U8Request> request);
  VideoTranscodeModel
  videoTranscode(shared_ptr<HostingVideoTranscodeRequest> request);
  CreateShareModel createShare(shared_ptr<CreateShareRequest> request);
  DeleteShareModel deleteShare(shared_ptr<DeleteShareRequest> request);
  GetShareModel getShare(shared_ptr<GetShareRequest> request);
  ListShareModel listShare(shared_ptr<ListShareRequest> request);
  UpdateShareModel updateShare(shared_ptr<UpdateShareRequest> request);
  ListStorefileModel listStorefile(shared_ptr<ListStoreFileRequest> request);

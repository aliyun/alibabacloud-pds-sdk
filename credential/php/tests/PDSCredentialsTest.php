...
namespace Aliyun\PDS\Credentials\Tests;
 ...
 * @coversNothing
 */
class PDSCredentialsTest extends TestCase
{
    public function testConstruct()
    {
        ...
        $credentials = new PDSCredentials($config);
    ...
    {
        $credentials = new PDSCredentials(new Config());

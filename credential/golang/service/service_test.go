...
func Test_refreshAccessToken(t *testing.T) {
	...
	at, rt, expireRaw, expire, err := refreshAccessToken("", "pds", "refresh_token", "client_id", "client_secret")
	...
	at, rt, expireRaw, expire, err = refreshAccessToken("endpoint", "pds", "refresh_token", "client_id", "client_secret")
	utils.AssertEqual(t, "", at)
	utils.AssertEqual(t, "", rt)
	utils.AssertEqual(t, "", expireRaw)
	utils.AssertEqual(t, int64(0), expire)
